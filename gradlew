...
#       requires the POSIX shell word splitting.
#
#   (2) For Cygwin or MSYS, switches are used to disable readline and interactive mode.
#
##############################################################################
...
# This is reliable for Cygwin and MSYS.
